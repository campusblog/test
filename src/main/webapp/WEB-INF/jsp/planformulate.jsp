    ...
    <div style="padding:0px 20px;">
        ...
        <table class="table table-hover" id="planinfo">
          ...
          <c:forEach items="${sal_plan }" var="l">
          	<tr>
          	<input type="hidden" value="${l.pla_id }" class="planid"/>
          	<input type="hidden" value="${l.pla_todo }" class="updatecontent"/>
            ...
            <!-- 添加计划 -->
            <form action="addPlanById" method="post">
            <tr>
            	<input type="hidden" value="${sal_chance.chc_id }" class="planid" name="chc_id"/>
            	<input name="pla_chc_id" value="${sal_chance.chc_id }"  type="hidden" class="planid"/>
            	<td align="center"><input type="date" class="form-control"  placeholder="请输入日期" name="pla_date"/></td>
                <td align="center" class="plancontent"><input type="text" class="form-control" placeholder="请输入计划项" name="pla_todo"/></td>
                <td align="center">
