...
<body>
    ...
    <div stlye="padding:20px;">
      <form role="form" method="post" action="Sys_user/insertUser">
            ...
            <td width="50%" height="50" align="center">
                 <div class="col-lg-3">
                    <div class="input-group">
                      ...
                      <select class="form-control" style="width:430px;" name="usr_role_id">
            ...
            <td width="50%" height="50" align="center">
             <div class="col-lg-3">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="必填项" required style="width:430px;" name="usr_name">
                </div>
             </div>
            </td>
            <td width="50%" height="50" align="center">
                 <div class="col-lg-3">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="必填项" required style="width:430px;" name="usr_password">
                    </div>
                </div>
            </td>
          </tr>
