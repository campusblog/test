				...
				<tr>
					...
					<td>
						<div class="filter-block pull-right" style="margin-left: 10px;">
							<a href="chancemanage.html" class="btn btn-primary pull-right">
				...
				<c:forEach items="${page.list }" var="c">
					<tr>
						...
						<p style="float: left;"><a
							href="toCustomerInfo?cust_no=${c.cust_no }" class="table-link">
								<span class="fa-stack"> <i
									class="fa fa-square fa-stack-2x"></i> <i
									class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
							</span>
						</a> </p>
						<p style="float: left;"><a href="#" class="table-link"> 
						<span class="fa-stack">
						...
						<p>
						<div class="btn1" style="float: right;">
  <div class="btn-back1">
    <p>您确定要删除吗？</p>
    <input type="hidden" value="${c.cust_no}" id="cust_no">
    <button class="yes" onclick="deleteCus()" value="" id="ok">确定</button>
    <button class="no">取消</button>
  </div>
  <div class="btn-front1" >删除</div>
</div>
						</p>
							<%-- <a href="doDelete?cust_no=${c.cust_no }"
...
<script src="js/delete.js"></script>
		<ul class="pager">
			<li><a
				href="toCustomer?pageNow=1&pageSize=3&cust_name=${cust_name }&cust_level_label=${cust_level_label}&cust_status=${cust_status}">首页</a></li>
			<c:if test="${page.pageNow >1}">
				<li><a
					href="toCustomer?pageNow=${page.pageNow-1}&cust_name=${cust_name }&cust_level_label=${cust_level_label}&cust_status=${cust_status}">上一页</a></li>
			</c:if>
			...
			<c:if test="${page.pageNow<page.pageCount}">
				<li><a
					href="toCustomer?pageNow=${page.pageNow+1}&cust_name=${cust_name }&cust_level_label=${cust_level_label}&cust_status=${cust_status}">下一页</a></li>
			</c:if>
			<li><a
				href="toCustomer?pageNow=${page.pageCount}&cust_name=${cust_name }&cust_level_label=${cust_level_label}&cust_status=${cust_status}">尾页</a></li>
		</ul>
	</div>
</body>
</html>